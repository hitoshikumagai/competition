...
#データ取得
train = feather.read_dataframe('./data/input/order_encoding_mix_train.feather')
X_test = feather.read_dataframe('./data/input/order_encoding_mix_test.feather')
...
#目的変数を対数化
comment="base_line+qual_order_encoding+log+delete_importance_0"
